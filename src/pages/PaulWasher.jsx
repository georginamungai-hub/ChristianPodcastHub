import '../cssFiles/paulWasher.css'
...
const PaulWasherPod =()=>{
    ...
    return(
        ...
        <div className='text'>
            <h1>Paul Washer</h1>
            <p>The latest podcast feed searching 'Paul Washer' on SermonAudio.</p>
        </div>
        ...
        <div className='flex flex-col gap-6'>
            {
                podcasts.map((podcast,index)=>{
                    ...
                    <img src="src\assets\paulW.png" alt="mainImg" className='rounded-md'/>
                </div>
                <div className='secondSegment'>
                    <h2>{podcast.title}</h2>
                    <div className='lastImage gap-2'>
