...
const johnMacarthurPod =()=>{
    ...
    return(
        ...
        <div className='text'>
            <h1>Grace To You</h1>
            <p>This powerful broadcast will boost your spiritual growth by helping you understand and apply God's Word to your life and the life of your family and church. John MacArthur, pastor-teacher, has been offering his practical, verse-by-verse Bible teaching through Grace to You for 40 years.</p>
        </div>
        ...
        <div className='flex flex-col gap-6'>
            {
                podcasts.map((podcast,index)=>{
                    ...
                    <img src="src\assets\johnM.jpeg" alt="mainImg" className='rounded-md'/>
                </div>
...
export default johnMacarthurPod
