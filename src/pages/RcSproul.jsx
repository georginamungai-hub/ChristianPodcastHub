        ...
        <div className='flex flex-col gap-6'>
            {
                podcasts.map((podcast,index)=>{
                    ...
                    <img src="src\assets\RcS.jpeg" alt="mainImg" className='rounded-md'/>
                </div>
