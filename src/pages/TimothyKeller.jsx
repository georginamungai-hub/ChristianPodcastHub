...
const timothyKellerPod =()=>{
    ...
    return(
        ...
        <div className='text'>
            <h1>Timothy Keller</h1>
            <p>Sermons by Tim Keller, founder of Redeemer Presbyterian Church in NYC and NY Times best-selling author of ”The Reason for God: Belief in an Age of Skepticism.” </p>
        </div>
        ...
        <div className='flex flex-col gap-6'>
            {
                podcasts.map((podcast,index)=>{
                    ...
                    <img src="src\assets\timothyK.jpeg" alt="mainImg" className='rounded-md'/>
                </div>
...
export default timothyKellerPod
